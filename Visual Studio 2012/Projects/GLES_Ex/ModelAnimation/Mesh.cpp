...
bool CMesh::LoadM3DModel(const std::string& _fileName)
{
	ReleaseSysMem();
	M3DModel m3d;
	if(!m3d.LoadM3DModel(_fileName,m_vertex,m_vStride,m_index, m_vOffset, m_texOffset,m_tanOffset,m_normalOffset))
		return false;
